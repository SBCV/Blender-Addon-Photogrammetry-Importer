...
class OpenGLPanel(bpy.types.Panel):
    ...
    def register(cls):
        ...
        bpy.types.Scene.opengl_panel_export_animation_settings = (
            PointerProperty(type=OpenGLPanelExportAnimationSettings)
        )
...
class SaveOpenGLRenderImageOperator(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        write_point_size = (
            context.scene.opengl_panel_write_settings.write_point_size
        )
        cam = get_selected_camera()
...
class ExportOpenGLRenderImageOperator(bpy.types.Operator, ExportHelper):
    ...
    def execute(self, context):
        ...
        file_format = (
            context.scene.opengl_panel_export_image_settings.file_format
        )
...
class ExportOpenGLRenderAnimationOperator(bpy.types.Operator, ExportHelper):
    ...
    def execute(self, context):
        ...
        use_camera_keyframes = (
            context.scene.opengl_panel_export_animation_settings.use_camera_keyframes
        )
        file_format = (
            context.scene.opengl_panel_export_image_settings.file_format
        )
